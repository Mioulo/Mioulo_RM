...
from utils1.google_utils import gsutil_getsize
from utils1.metrics import fitness
from utils1.torch_utils import init_torch_seeds
...
def xyxy2xywh(x):
    ...
    # 就可以写一个函数把这个x center和y center给返回了
...
def non_max_suppression(prediction, conf_thres=1, iou_thres=0.1, classes=None, agnostic=False, multi_label=False,
                        labels=()):
